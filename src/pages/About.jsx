      ...
      <div className="gallery-block">
        ...
        <div className="block-text">
          ...
          <p>
            ...
            graphics and learning recources being more accessible than ever ,
            now seemed like a perfect time to transition to a career in web
            ...
            user-friendly websites. I am a lifelong learner who is always
            seeking to improve my skills and stay up-to-date with the latest
            technologies in the field. I am excited to bring my unique
            perspective and passion for web development to a new role and
            contribute to the continued growth of the industry.{" "}
          </p>
        </div>
      </div>
    </div>
